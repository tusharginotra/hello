    ...
    <>
      <nav className={`navbar fixed-top navbar-expand-lg navbar-${props.mode ==='light' ? 'dark':'light'} bg-${props.mode === 'light' ? 'dark' : 'light'}`}  >
        <div className="container-fluid">
          <a className="navbar-brand top-fixed" href="/">{props.title}</a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button type="button" onClick={() => { document.body.style.backgroundColor = '#446dab' }} className="btn btn mx-2" style={{ backgroundColor: "#446dab" }}></button>
